...
*/
uint8_t* Get_Data8_Table(uint8_t func_code) {
...
uint16_t* Get_Data16_Table(uint8_t func_code) {
...
// void ReadCoil(uint8_t start_coil_addr, uint8_t num_of_coils, uint8_t *coil_data){
//     uint8_t end_coil_addr = start_coil_addr + (num_of_coils - 1);
//     uint8_t start_coil_table_index = start_coil_addr / 8;
//     uint8_t start_coil_table_index_bit_pos = start_coil_addr % 8;
//     uint8_t end_coil_table_index = end_coil_addr / 8;
//     uint8_t end_coil_table_index_bit_pos = end_coil_addr % 8;
//     // TODO: declare below line in main()
//     // coil_data[(int)((num_of_coils + 7)/8)]
//     memset(coil_data, 0, (int)((num_of_coils + 7)/8));
    
//     // looping code that copies the on or off status from coils array to coil_data bit by bit from lsb and to msb
...
uint8_t Read_Coil(uint8_t func_code, uint16_t start_coil_addr, uint16_t num_of_coils, uint8_t *coil_data) {
    ...
    uint8_t *point_to_data_table = Get_Data8_Table(func_code);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// int main() {
//     test_read_coil(); printf("\n-----------------------------\n");
//     test_write_coil(); printf("\n-----------------------------\n");
//     test_read_reg(); printf("\n-----------------------------\n");
//     test_write_reg(); printf("\n-----------------------------\n");
//     test_build_modbus_response(); printf("\n-----------------------------\n");
//     test_serialise_buffer(); printf("\n-----------------------------\n");
