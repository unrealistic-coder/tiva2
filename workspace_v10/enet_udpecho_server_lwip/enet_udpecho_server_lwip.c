//*****************************************************************************
//
// enet_udpecho_server_lwip.c - Sample UDP Echo Server using lwIP.
//
...
//! <h1>Ethernet UDP Server with lwIP (enet_udpecho_server_lwip)</h1>
//!
//! This UDP Echo server application demonstrates the operation of the Tiva
//! Ethernet controller using the lwIP TCP/IP Stack.  The server will echo
//! back any data that it receives from the client. The DHCP is used to obtain
...
//*****************************************************************************
//
// UdpEchoRecv is the callback function to be called when the server receives
...
//*****************************************************************************
//
// Initialize an UDP connection and register the callback function when
