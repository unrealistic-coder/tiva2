...
override PKGDIR = xconfig_httpsget
...
package/%.xdc.inc package/%_xconfig_httpsget.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_httpsget" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: httpsget.pem4f

-include package/cfg/httpsget_pem4f.mak
-include package/cfg/httpsget_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/httpsget_pem4f.dep
endif
httpsget.pem4f: package/cfg/httpsget_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
httpsget.pem4f package/cfg/httpsget_pem4f.c: .libraries,em4f
endif

package/cfg/httpsget_pem4f.c package/cfg/httpsget_pem4f.h package/cfg/httpsget_pem4f.xdl: override _PROG_NAME := httpsget.xem4f
package/cfg/httpsget_pem4f.c: package/cfg/httpsget_pem4f.cfg
package/cfg/httpsget_pem4f.xdc.inc: package/cfg/httpsget_pem4f.xdl
package/cfg/httpsget_pem4f.xdl package/cfg/httpsget_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/httpsget_pem4f.cfg
	-$(RM) package/cfg/httpsget_pem4f.dep
	-$(RM) package/cfg/httpsget_pem4f.c
	-$(RM) package/cfg/httpsget_pem4f.xdc.inc

clean,em4f::
	-$(RM) httpsget.pem4f
.executables,em4f .executables: httpsget.xem4f

httpsget.xem4f: |httpsget.pem4f

-include package/cfg/httpsget.xem4f.mak
httpsget.xem4f: package/cfg/httpsget_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/httpsget_pem4f.oem4f   package/cfg/httpsget_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
httpsget.xem4f: export C_DIR=
httpsget.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
httpsget.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

httpsget.test test,em4f test: httpsget.xem4f.test

httpsget.xem4f.test:: httpsget.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 httpsget.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.httpsget.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,httpsget.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
httpsget_pem4f.oem4f,copy : package/cfg/httpsget_pem4f.oem4f
httpsget_pem4f.sem4f,copy : package/cfg/httpsget_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_httpsget
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_httpsget.tar.dep
endif
package/rel/xconfig_httpsget/xconfig_httpsget/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_httpsget/xconfig_httpsget/package/package.rel.xml: package/build.cfg
package/rel/xconfig_httpsget/xconfig_httpsget/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_httpsget/xconfig_httpsget/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_httpsget.tar: package/rel/xconfig_httpsget.xdc.inc package/rel/xconfig_httpsget/xconfig_httpsget/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_httpsget.xdc.inc,package/rel/xconfig_httpsget.tar.dep)


release release,xconfig_httpsget: all xconfig_httpsget.tar
clean:: .clean
	-$(RM) xconfig_httpsget.tar
	-$(RM) package/rel/xconfig_httpsget.xdc.inc
	-$(RM) package/rel/xconfig_httpsget.tar.dep
