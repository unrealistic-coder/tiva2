 ...
 */
xdc__META(__ASM__, "@(#)__ASM__ = C:/Users/a0321879/Documents/My CCS Ethernet NDK Examples/enet_dns_tirtos/Debug/configPkg/package/cfg/dns_pem4f");
...
static void ti_ndk_config_Global_NetworkIPAddr(IPN IPAddr, uint IfIdx, uint fAdd)
{
    ...
    {
        extern Void dnsHooks();

        /* call user defined network IP address hook */
        dnsHooks(IPAddr, IfIdx, fAdd);
    }
    xdc_runtime_System_flush();
}
/*
...
__FAR__ const CT__ti_ndk_rov_Ndk_Module__id ti_ndk_rov_Ndk_Module__id__C = (xdc_Bits16)0x8027;
