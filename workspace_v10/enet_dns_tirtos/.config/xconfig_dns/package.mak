...
package/%.xdc.inc package/%_xconfig_dns.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_dns" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: dns.pem4f

-include package/cfg/dns_pem4f.mak
-include package/cfg/dns_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/dns_pem4f.dep
endif
dns.pem4f: package/cfg/dns_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
dns.pem4f package/cfg/dns_pem4f.c: .libraries,em4f
endif

package/cfg/dns_pem4f.c package/cfg/dns_pem4f.h package/cfg/dns_pem4f.xdl: override _PROG_NAME := dns.xem4f
package/cfg/dns_pem4f.c: package/cfg/dns_pem4f.cfg
package/cfg/dns_pem4f.xdc.inc: package/cfg/dns_pem4f.xdl
package/cfg/dns_pem4f.xdl package/cfg/dns_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/dns_pem4f.cfg
	-$(RM) package/cfg/dns_pem4f.dep
	-$(RM) package/cfg/dns_pem4f.c
	-$(RM) package/cfg/dns_pem4f.xdc.inc

clean,em4f::
	-$(RM) dns.pem4f
.executables,em4f .executables: dns.xem4f

dns.xem4f: |dns.pem4f

-include package/cfg/dns.xem4f.mak
dns.xem4f: package/cfg/dns_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/dns_pem4f.oem4f   package/cfg/dns_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
dns.xem4f: export C_DIR=
dns.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
dns.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

dns.test test,em4f test: dns.xem4f.test

dns.xem4f.test:: dns.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 dns.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.dns.xem4f, ) 
endif
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
dns_pem4f.oem4f,copy : package/cfg/dns_pem4f.oem4f
dns_pem4f.sem4f,copy : package/cfg/dns_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_dns
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_dns.tar.dep
endif
package/rel/xconfig_dns/xconfig_dns/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_dns/xconfig_dns/package/package.rel.xml: package/build.cfg
package/rel/xconfig_dns/xconfig_dns/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_dns/xconfig_dns/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_dns.tar: package/rel/xconfig_dns.xdc.inc package/rel/xconfig_dns/xconfig_dns/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_dns.xdc.inc,package/rel/xconfig_dns.tar.dep)


release release,xconfig_dns: all xconfig_dns.tar
clean:: .clean
	-$(RM) xconfig_dns.tar
	-$(RM) package/rel/xconfig_dns.xdc.inc
	-$(RM) package/rel/xconfig_dns.tar.dep
