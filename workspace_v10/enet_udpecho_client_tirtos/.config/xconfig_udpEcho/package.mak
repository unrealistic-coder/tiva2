...
override PKGDIR = xconfig_udpEcho
...
package/%.xdc.inc package/%_xconfig_udpEcho.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_udpEcho" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: udpEcho.pem4f

-include package/cfg/udpEcho_pem4f.mak
-include package/cfg/udpEcho_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/udpEcho_pem4f.dep
endif
udpEcho.pem4f: package/cfg/udpEcho_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
udpEcho.pem4f package/cfg/udpEcho_pem4f.c: .libraries,em4f
endif

package/cfg/udpEcho_pem4f.c package/cfg/udpEcho_pem4f.h package/cfg/udpEcho_pem4f.xdl: override _PROG_NAME := udpEcho.xem4f
package/cfg/udpEcho_pem4f.c: package/cfg/udpEcho_pem4f.cfg
package/cfg/udpEcho_pem4f.xdc.inc: package/cfg/udpEcho_pem4f.xdl
package/cfg/udpEcho_pem4f.xdl package/cfg/udpEcho_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/udpEcho_pem4f.cfg
	-$(RM) package/cfg/udpEcho_pem4f.dep
	-$(RM) package/cfg/udpEcho_pem4f.c
	-$(RM) package/cfg/udpEcho_pem4f.xdc.inc

clean,em4f::
	-$(RM) udpEcho.pem4f
.executables,em4f .executables: udpEcho.xem4f

udpEcho.xem4f: |udpEcho.pem4f

-include package/cfg/udpEcho.xem4f.mak
udpEcho.xem4f: package/cfg/udpEcho_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/udpEcho_pem4f.oem4f   package/cfg/udpEcho_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
udpEcho.xem4f: export C_DIR=
udpEcho.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
udpEcho.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

udpEcho.test test,em4f test: udpEcho.xem4f.test

udpEcho.xem4f.test:: udpEcho.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 udpEcho.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.udpEcho.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,udpEcho.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
udpEcho_pem4f.oem4f,copy : package/cfg/udpEcho_pem4f.oem4f
udpEcho_pem4f.sem4f,copy : package/cfg/udpEcho_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_udpEcho
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_udpEcho.tar.dep
endif
package/rel/xconfig_udpEcho/xconfig_udpEcho/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_udpEcho/xconfig_udpEcho/package/package.rel.xml: package/build.cfg
package/rel/xconfig_udpEcho/xconfig_udpEcho/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_udpEcho/xconfig_udpEcho/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_udpEcho.tar: package/rel/xconfig_udpEcho.xdc.inc package/rel/xconfig_udpEcho/xconfig_udpEcho/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_udpEcho.xdc.inc,package/rel/xconfig_udpEcho.tar.dep)


release release,xconfig_udpEcho: all xconfig_udpEcho.tar
clean:: .clean
	-$(RM) xconfig_udpEcho.tar
	-$(RM) package/rel/xconfig_udpEcho.xdc.inc
	-$(RM) package/rel/xconfig_udpEcho.tar.dep
