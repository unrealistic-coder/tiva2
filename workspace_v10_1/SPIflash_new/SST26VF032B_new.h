...
#ifndef SST26VF032B_NEW_H_
#define SST26VF032B_NEW_H_

#include <stdint.h>
#include <stdbool.h>

//CODE EXCLUSION MACROS
#define TIMER 0
#define DEBUG 0


//static volatile bool g_eotInt = false;
...
uint8_t ReadStatus();
uint8_t ReadConfig();
uint8_t ReadFlash(uint32_t addr, uint32_t bytes, uint8_t* buffer, bool flash);
void ResetFlash();
void wait();
