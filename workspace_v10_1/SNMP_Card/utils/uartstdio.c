...
//* File: uartstdio.c
//*
//* Synopsis: Utility driver to provide simple UART console functions
//*
//*
//****************************************************************************
...
//****************************************************************************
//*
//* Function name: GetBufferCount
//*
//* Return:  uint32_t Returns the number of bytes of data in the buffer
//*
//*
//* Description:
...
//****************************************************************************
//*
//* Function name: UARTPrimeTransmit
//*
//* Return:  None
//*
//*
//* Description:
//*   Take as many bytes from the transmit buffer as we have space for
//*   and move them into the UART transmit FIFO.
//*
//****************************************************************************
//============================================================================
...
//*
//* Return:  int return no of characters.
//*
//*
//* Description:
...
//*
//* Return:  int retunr Count of characters that were stored not including
//*  		 the trailing 0.
//*
//*
//* Description:
...
//*
//* Return:  int  Returns the character read.
//*
//*
//* Description:
//*   This function will transmit the string to the UART output.  The number of
...
//****************************************************************************
//*
//* Function name: UARTRxBytesAvail
//*
//* Return:  int - return RX_BUFFER_USED(Available bytes)
//*
//*
//* Description:
//*   This function returns Avaiable bytes from UART FIFO.
//*
//****************************************************************************
//============================================================================
...
//* Function name: UARTRxBytesAvail
//*
//* Return:  int - the number of bytes free in the transmit buffer.
//*
//*
//* Description:
...
//****************************************************************************
//*
//* Function name: UARTPeek
//*
//* Return:  int - Returns a non-negative number if the character was
//*                found in which case the value represents the position 
//*                of the first instance of \e ucChar relative to the receive 
//*                buffer read pointer. 	
...
//****************************************************************************
//*
//* Function name: UARTStdioIntHandler
//*
//* Return:  None
//*
//* Description:
