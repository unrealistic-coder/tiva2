...
#define _MULTI_PARTITION    1// 0 /* 0:Single partition, 1:Multiple partition */
...
#define _MIN_SS    512//4096//512  /* 512, 1024, 2048 or 4096 */
...
#define _FS_LOCK    0 //2 //for testing    /* 0:Disable or >=1:Enable */
