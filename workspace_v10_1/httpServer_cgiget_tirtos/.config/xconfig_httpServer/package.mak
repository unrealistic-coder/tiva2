...
override PKGDIR = xconfig_httpServer
...
package/%.xdc.inc package/%_xconfig_httpServer.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_httpServer" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,em4f .dlls: httpServer.pem4f

-include package/cfg/httpServer_pem4f.mak
-include package/cfg/httpServer_pem4f.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/httpServer_pem4f.dep
endif
httpServer.pem4f: package/cfg/httpServer_pem4f.xdl
	@


ifeq (,$(wildcard .libraries,em4f))
httpServer.pem4f package/cfg/httpServer_pem4f.c: .libraries,em4f
endif

package/cfg/httpServer_pem4f.c package/cfg/httpServer_pem4f.h package/cfg/httpServer_pem4f.xdl: override _PROG_NAME := httpServer.xem4f
package/cfg/httpServer_pem4f.c: package/cfg/httpServer_pem4f.cfg
package/cfg/httpServer_pem4f.xdc.inc: package/cfg/httpServer_pem4f.xdl
package/cfg/httpServer_pem4f.xdl package/cfg/httpServer_pem4f.c: .interfaces

clean:: clean,em4f
	-$(RM) package/cfg/httpServer_pem4f.cfg
	-$(RM) package/cfg/httpServer_pem4f.dep
	-$(RM) package/cfg/httpServer_pem4f.c
	-$(RM) package/cfg/httpServer_pem4f.xdc.inc

clean,em4f::
	-$(RM) httpServer.pem4f
.executables,em4f .executables: httpServer.xem4f

httpServer.xem4f: |httpServer.pem4f

-include package/cfg/httpServer.xem4f.mak
httpServer.xem4f: package/cfg/httpServer_pem4f.oem4f 
	$(RM) $@
	@$(MSG) lnkem4f $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.arm.elf.M4F.rootDir)/bin/armcl -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --silicon_version=7M4 -z --strict_compatibility=on  -o $@ package/cfg/httpServer_pem4f.oem4f   package/cfg/httpServer_pem4f.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.arm.elf.M4F.rootDir)/lib/libc.a
	
httpServer.xem4f: export C_DIR=
httpServer.xem4f: PATH:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)
httpServer.xem4f: Path:=$(ti.targets.arm.elf.M4F.rootDir)/bin/;$(PATH)

httpServer.test test,em4f test: httpServer.xem4f.test

httpServer.xem4f.test:: httpServer.xem4f
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 httpServer.xem4f.test
else
	@$(MSG) running $<  ...
	$(call EXEC.httpServer.xem4f, ) 
endif

clean,em4f::
	-$(RM) $(wildcard .tmp,httpServer.xem4f,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
httpServer_pem4f.oem4f,copy : package/cfg/httpServer_pem4f.oem4f
httpServer_pem4f.sem4f,copy : package/cfg/httpServer_pem4f.sem4f

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_httpServer
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_httpServer.tar.dep
endif
package/rel/xconfig_httpServer/xconfig_httpServer/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_httpServer/xconfig_httpServer/package/package.rel.xml: package/build.cfg
package/rel/xconfig_httpServer/xconfig_httpServer/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_httpServer/xconfig_httpServer/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_httpServer.tar: package/rel/xconfig_httpServer.xdc.inc package/rel/xconfig_httpServer/xconfig_httpServer/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_httpServer.xdc.inc,package/rel/xconfig_httpServer.tar.dep)


release release,xconfig_httpServer: all xconfig_httpServer.tar
clean:: .clean
	-$(RM) xconfig_httpServer.tar
	-$(RM) package/rel/xconfig_httpServer.xdc.inc
	-$(RM) package/rel/xconfig_httpServer.tar.dep
